---
slug: semantic-natural-selection
title: Semantic Natural Selection
...
Semantic natural selection is the framework's name for the diachronic face of recursive marking: the process by which content-bearing structures that are exposed to encounter survive, change, or die, and by which the survivors accumulate as the residue named on [[postfalsifiability|Postfalsifiability]] and compressed on [[crystallization|Crystallization]]. It runs one cycle:
...
Meaning-structures differ along at least six axes — **survival, accuracy, answerability, compressibility, reproductive success, and resistance to corruption** — and these criteria may diverge. A form can spread while going blind; a correct form can die unread. Accordingly: **do not equate persistence, popularity, or reproductive success with truth.**
...
- **[[causal-falsifiability|Causal falsifiability]]**: an encounter contributes to selection where it can affect retention, revision, or reconstruction. A valid objection remains valid even if the target ignores it. Storage, citation, or display can contribute to selection where they change differential retention or reconstruction; their presence alone does not establish it.
...
Isolated from the marking-and-accuracy discipline, the selection model degrades into **social-selectionism**: might-makes-right, popularity-as-validity, survival-as-proof. That is the [[spectre|Spectre]] reading — the world's selection pressure absolutized into the arbiter of meaning — and it is exactly the inference the coupling exists to forbid. The [[theodicytes|Theodicytes]] make the danger concrete: a form can raise its reproductive success by [[capture-of-corrective-layer|capturing its own corrective layer]], gaining fitness while shedding answerability, so an unregulated fitness reading would *reward* corruption.

Isolated the other way — accuracy and answerability with no account of selection — the framework can say which forms are good but cannot explain why the residue it holds is the residue that survived. Crystallization becomes an unexplained given rather than an earned outcome, and persistence is left to look like accident or untested luck.
...
[[postfalsifiability|Postfalsifiability]] · [[crystallization|Crystallization]] · [[outcomes-of-attack|The Outcomes of Attack]] · [[causal-falsifiability|Causal Falsifiability]] · [[negative-information|Negative Information]] · [[scar-record|The Scar Record]] · [[semantic-closure-and-recursive-marking|Semantic Closure and Recursive Marking]] · [[theodicytes|The Theodicytes]] · [[symbolic-immortality|Symbolic Immortality]]
