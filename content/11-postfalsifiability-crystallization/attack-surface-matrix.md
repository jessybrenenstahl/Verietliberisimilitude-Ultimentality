...
| Reconciliation | coupled controller (Apology ⊕ Gratitude) | removal test; show the gating is not sequential | the sentimental form / guilt-loop | sequential gating (own the fault, then carry value outward) | Apology alone → guilt-loop; Gratitude alone → cheap grace | fault owned, then value carried outward | reconciliation not decomposable into Apology-then-Gratitude | distinguish the Apology–Gratitude composition from any object being reconciled | [[reconciliation]] |
