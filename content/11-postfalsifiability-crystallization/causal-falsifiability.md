---
slug: causal-falsifiability
title: Causal Falsifiability
section: postfalsifiability-and-crystallization
page_type: load-bearing
formal_status:
  epistemic: Derived
  tier: CV
  alethic: aspires to map the observable difference between a governed system that can be moved by an objection and one that cannot
prerequisites: [falsification-standard, causal-error-mark, outcomes-of-attack]
regulates: [falsification-standard, answerability-predicate, effective-and-ornamental-answerability]
regulated_by: [outcomes-of-attack, same-level-attack-rule, scar-record]
valid_attack: "Exhibit a legitimate falsification whose force is wholly independent of any causal contact with the target, showing the causal requirement conflates system-effect with truth or is neither necessary nor available as a proxy."
isolation_failure: "Without the preserved-marking side and the outcomes classification the causal demand degrades into churn-theater; drop the causal demand and falsification collapses back into ornament."
kill_condition: "The framework's own logged falsifiers provably leave every relevant output and governance decision unchanged, or the required evidence-to-changed-state trace cannot be reproduced."
see_also: [causal-error-mark, effective-and-ornamental-answerability, outcomes-of-attack, postfalsifiability, falsification-standard, self-sealing-test, scar-record, same-level-attack-rule, answerability-predicate]
application_tags: []
---
