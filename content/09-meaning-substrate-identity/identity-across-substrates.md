---
slug: identity-across-substrates
title: Identity Across Substrates
section: meaning-substrate-and-identity
page_type: load-bearing
formal_status:
  epistemic: Derived
  tier: CV
  alethic: aims to track when distinct carriers realize one operation versus merely resemble it; inaccurate wherever substrate is made either decisive or irrelevant
prerequisites: [meaning-maker, symbolic-is-not-linguistic, causal-source-and-experiential-format]
regulates: ["substrate reductionism", "type inflation", "token/type confusion", "substrate/function confusion"]
regulated_by: [same-level-attack-rule, participant-as-process, prohibited-collapses]
valid_attack: "Two processes satisfy the same type description yet differ in a behavior the type was meant to predict."
isolation_failure: "Type identity without a capacity profile inflates into carrier-blind sameness; a capacity profile without type identity fragments into per-substrate nominalism."
kill_condition: "The type is so thin that every difference is relegated to substrate, making the classification explanatorily empty."
see_also: [meaning-maker, participant-as-process, semantic-transformer, symbolic-is-not-linguistic, same-level-attack-rule]
application_tags: []
---
...
3. **Substrate realization** — the material or symbolic organization carrying the type, where "symbolic" is [[symbolic-is-not-linguistic|any structured significance capable of differentiated consequence]] — chemical, electronic, procedural, inscribed.
...
**E: Derived, CV.** This is a carving of one identity relation into four levels. It is contestable by counter-instance — two carriers that meet the type yet diverge on exactly what the type was meant to predict — and by a better carving, one that needs fewer levels or an indispensable fifth. It is not FT: the four-level split is a proposed decomposition, not something forced by the accepted definitions; the levels are themselves a [[carving-tier|CV carving]]. **A:** the account aspires to map when distinct carriers realize one operation versus when they merely resemble it; it is inaccurate wherever substrate is treated as decisive or as irrelevant. This is a **treatise-side extension, held contestable** — not canon, not a fixed count, and no level is exempt from marking.

## What it regulates

It holds two opposed excesses apart at once.

- **Substrate reductionism** — the move that reads a difference in carrier as automatically a difference in kind ("it is only silicon / only tissue / only ink, therefore not the same operation"). The [[same-level-attack-rule|same-level attack rule]] names this precisely as *substrate offered against function*, an invalid move.
...
- **A capacity profile without type identity** fragments into per-substrate nominalism: every carrier becomes its own kind, no operation is ever the same twice, and no [[one-generator-many-domains|instantiation of one relation across domains]] can be stated at all.
...
[[meaning-maker|The Meaning-Maker]] · [[participant-as-process|The Participant as Process]] · [[semantic-transformer|The Semantic Transformer]] · [[symbolic-is-not-linguistic|Symbolic Is Not Linguistic]] · [[causal-source-and-experiential-format|Causal Source and Experiential Format]] · [[same-level-attack-rule|The Same-Level Attack Rule]] · [[one-generator-many-domains|One Generator, Many Domains]] · [[prohibited-collapses|The Prohibited Collapses]] · [[category-error-atlas|The Category-Error Atlas]]
