...
- **One change as proof.** Effectiveness is counterfactual capacity, not a token event. A system may permit a single cosmetic revision to certify itself while the governing telos stays sealed; that is [[capture-of-corrective-layer|capture]], not effect.
