---
slug: causal-error-mark
title: The Error Mark With Causal Force
section: answerability-and-anti-capture
page_type: load-bearing
formal_status:
  epistemic: Derived
  tier: FT
  alethic: "aspires to mark the real difference between systems that can be corrected and systems that only display correction; the decorative reading is inaccurate, not merely disallowed"
prerequisites: [predicate-binding, regulated-error-signal, answerability-predicate, two-mark-system]
