---
slug: hypercompression
title: Hypercompression
section: hypercompression-and-reconstruction
page_type: load-bearing
formal_status:
  epistemic: Derived
  tier: CV
  alethic: "the surface-is-decompression claim maps an actual dependency structure and can fail against it"
prerequisites: [derived, two-mark-system, semantic-closure-and-recursive-marking]
regulates: ["loose doctrinal aggregation (the grab-bag reading)", "sloganization", "accretion mistaken for coverage"]
regulated_by: [minimal-rebuild-string, system-invariants, compression-without-false-closure, negative-information]
valid_attack: "Exhibit two materially incompatible reconstructions that satisfy the same alleged kernel, with no internal rule able to select between them."
isolation_failure: "Compression without decompression tests becomes oracular shorthand; decompression without compression becomes an inventory without architecture."
kill_condition: "The proposed kernel cannot regenerate one or more system invariants, or can regenerate them only by importing unstated doctrine."
see_also: [ultimental-kernel, minimal-rebuild-string, decompression-map, compression-without-false-closure, description-length-and-explanatory-surface, negative-information, scar-record, system-invariants]
application_tags: []
---
