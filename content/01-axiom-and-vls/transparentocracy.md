...
The decisive operational test is whether a corrective process can change what it examines. Staffing, funding, and ownership can affect that capacity, but do not decide it alone. [[capture-of-corrective-layer|Capture]] occurs when the governed process can neutralize a relevant correction while preserving its appearance. A correction integrated into the participant can be effective; a nominally external auditor can be captured. [[effective-and-ornamental-answerability|Effective answerability]] is established by the retained route from evidence to consequential change.
